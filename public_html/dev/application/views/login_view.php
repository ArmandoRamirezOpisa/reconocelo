...
<html>
  ...
  <body>
    ...
    <div class="container contLogin">
      ...
      <div style="text-align:center;width:60%;max-width:300px;margin:20px auto;">
        <img style="width:100%;height:auto;" src="assets/images/reconocelo.png">
      </div> 
        
      <form class="form-signin" role="form">
      
        <div class="form-group">
            <label class="lblText" for="usuario">Usuario (Ingrese sin el guion)</label>
        ...
        <a href="javascript:void(0)" onClick="valLogin()" class="btn btn-lg btn-block" style="background:#00488B;color:#FFF;">Entrar</a>
      </form>

    </div> <!-- /container -->
    <center><h6>Para una correcta visualizaci&oacute;n del sitio se recomienda el uso de<br>Chrome, Firefox, Internet Explorer 11 o superior</h6></center>
