<div class="col-md-12">
  ...
  <thead class="thead navcolor text-white">
    ...
    <!--<div><h4>Direcci&oacute;n de env&iacute;o</h4>-->
    <?php
    ...
    <!--<a href="javascript:void(0)" onclick="loadSection('cart_controller/getCategory','dvSecc')" class=" btn btn-outline-secondary" id="btnGenCanje">Continuar comprando</a>-->
</div>
...
<div class="card card-column bg-light mb-3">
  <div class="card-header"><h2 class= "text-center"><i class="fas fa-map-marker-alt mr-2"></i>Direcci&oacute;n de entrega</h2></div>
  <div class="card-body">
    <h5 class="card-title">Ingrese o actualice la direcci&oacute;n a la que ser&aacute;n enviados los productos.</h5>
