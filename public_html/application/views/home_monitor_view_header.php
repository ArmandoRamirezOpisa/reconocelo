                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a id="depositosPuntosInsertar" class="dropdown-item" href="javascript:void(0)" onClick = "MonitorNav(this)" style="display:none;"><i class="fas fa-piggy-bank mr-2"></i>Insertar Depositos</a>
                        </div>
                    </li>
                    <li class="nav-item">
