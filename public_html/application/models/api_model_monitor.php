    ...
    class Api_model_monitor extends CI_Model {
        ...
        public function obtenerParticipantes($idCodPrograma, $codEmpresa) {
            $query = $this->db->query("
                ...
                where codPrograma = $idCodPrograma 
                and codEmpresa = $codEmpresa 
                and Periodo = '" . '2018-01-01' . "'                                       
            ; ");
        ...
        public function login($usuario,$password){
            $query = $this->db->query("          
                ...
                pr on adm.CodPrograma = pr.codPrograma inner join opisa_opisa.Empresa as emp 
                on emp.codEmpresa = adm.CodEmpresa 
                and adm.Usuario = '".$usuario."' 
                and adm.Pwd = '".$password."'                                                        
            ;");
