<?php
    class Cart_model extends CI_Model {
      ...
      public function getCategory()
      {
            ...
            WHERE cp.esBaja=0 
            AND p.codPremio in (SELECT codPremio 
                              FROM PremioPrograma 
                              WHERE codPrograma = ".$this->session->userdata('programa').") 
            ORDER BY cp.nbCategoria*/
            //Si la cuenta con la que se ingresa a la plataforma es la usada como DEMO, 
            //se visualizarán todas las categorias, de lo contrario solo se habilitaran las 
            //categorias que contienen premios menores o iguales al saldo del participante.
