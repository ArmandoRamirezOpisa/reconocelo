...
<html ng-app="login">
    <head>
        ...
        <link href="../../assets/css/2018ReconoceloLogin.css" rel="stylesheet">
        <link href="../../assets/css/2018ReconoceloButtons.css" rel="stylesheet">
    ...
    <body ng-controller="controller_login" >
            ...
            <div class="row justify-content-center mt-2 mb-4">
                <!--
                 <div class="col-12 col-md-4 mt-4">
                     <img  class="img-fluid mt-4" alt="Responsive image">
                 </div>
                -->
 ...
 <!--   <img class="card-img-top px-4 py-4" src="assets/images/reconocelo.png" alt="Card image cap"> -->
                                ...
                                <div class="col ">
                                    <form class="form-signin" role="form">
                                        ...
                                        <div class="form-group">
                                            <!-- 
                                          <label class="lblText mt-4" for="usuario">Usuario (Ingrese sin el guion)</label>
                                            -->
                                        ...
                                        <div class="form-group mb-4">
                                            <!-- 
                                             <label class="lblText" for="password">Contrase&ntilde;a</label>
                                            -->
                                            <div class="input-group mb-2 mr-sm-2">
                                        ...
                                        <small class="form-text text-muted text-center">  
                                            <a href="<?php echo site_url('recupera_passpord_controller/RecuperarUsuario') ?>"><h5>Olvidaste tu contraseña?</h5></a> 
                                        </small>
                                    </form> 
        ...
        <script src="../../assets/js/Controller_Login_dev.js" type="text/javascript"></script>
        ...
        <script src="../../assets/js/login_dev.js"></script>
